...
const Main = () => {
  return (
    <div>
      ...
      <div className="w-50 px-3 py-5 mx-auto text-center">
      ...
      <div className="container">
        <div className="card-deck mb-3 text-center d-flex justify-content-center gap-5">
          <div className="card mb-4 shadow-sm border-primary" style={{ width: '300px' }}>
